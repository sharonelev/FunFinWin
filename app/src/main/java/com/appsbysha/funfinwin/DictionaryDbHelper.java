...
public class DictionaryDbHelper extends SQLiteOpenHelper {
    ...
    public final static String DATABASE_PATH = "/data/data/com.appsbysha.funfinwin/databases/";
    ...
    public int getTableSize(String tableName) {
        return (int) DatabaseUtils.queryNumEntries(dictionaryDB, tableName);
    ...
    public String get_word(int numberOfLetters) {
        String TABLE_NAME = "dict_" + numberOfLetters + "_letter_words";
        int numOfValues = getTableSize(TABLE_NAME);
        final int randomNum = new Random().nextInt(numOfValues);
        String limit = randomNum + " ,1";
        String[] COLUMN_NAME = {"word"};
        //  Cursor cursor = dictionaryDB.rawQuery("SELECT word FROM "+ TABLE_NAME + " LIMIT " +randomNum+ " ,1", null);
        Cursor cursor = dictionaryDB.query(TABLE_NAME, null, null, null, null, null, null, limit);
        String value = "";
